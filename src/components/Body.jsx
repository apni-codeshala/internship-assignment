...
const Body = () => {
    ...
    // If restaurant length is zero than load shimmer
    return allRestaurants.length == 0 ?
        // If length not equal to zero than render restaurant
        (<BodyShimmer />) : filteredRestaurants?.length != 0 ? (
            <div style={{ backgroundColor: '#3d3d3d' }} className="min-h-[100vh]">
                <form 
            ...
            <div style={{ backgroundColor: '#3d3d3d' }} className="min-h-[100vh]">
                ...
                {/* If search query doesn't match any restaurant */}
                <div className="flex flex-wrap justify-center gap-10 p-10 text-white font-bold text-2xl">
