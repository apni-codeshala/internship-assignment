...
const RestaurantCard = ({...restaurant }) => {
    ...
    return (
        <section className="w-80 shadow-xl rounded-t-md rounded bg-purple-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer" style={{backgroundColor: '#d6cece'}}>
            ...
            <h2 className="font-semibold mb-2">{restaurant.costForTwo + " - " + restaurant.sla.deliveryTime + " Min Away"}</h2>
            <div className="px-6 pb-2 h-30">
                ...
                <button type="button"  className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 rounded-full text-1xl font-bold px-5 py-0.5 text-center me-2  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">+</button>
            </div>
        </section>   
    )
}
